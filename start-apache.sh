...
[[ -n "$REGISTRY_PORT_5000_TCP_ADDR" ]] && ENV_DOCKER_REGISTRY_HOST=$REGISTRY_PORT_5000_TCP_ADDR
[[ -n "$REGISTRY_PORT_5000_TCP_PORT" ]] && ENV_DOCKER_REGISTRY_PORT=$REGISTRY_PORT_5000_TCP_PORT
